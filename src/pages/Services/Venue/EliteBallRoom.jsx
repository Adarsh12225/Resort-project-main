...
// Hero Image
import heroImg from "../../../assets/grand-hall-1.jpg";
    ...
    <div className="w-full">
      ...
      <section className="relative w-full h-[60vh]">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-bold">Elite Ballroom</h1>
          <p className="mt-4 text-lg md:text-2xl max-w-2xl">
            An elegant venue for intimate weddings, conferences & special events
          </p>
        </div>
      </section>
      ...
      <section className="py-16 container mx-auto px-6">
        <h2 className="text-3xl font-bold text-gray-800 mb-6">
          Elite <span className="text-blue-800">Ball Room</span>
        </h2>
        <p className="text-gray-600 leading-relaxed mb-8">
          The Elite Ball Room is a premium space designed for sophisticated
          gatherings. With elegant interiors, modern amenities, and versatile
          seating arrangements, it’s the ideal choice for weddings, parties, and
          corporate functions.
        </p>
            ...
            <table className="w-full border border-gray-300 text-sm shadow-sm">
              <tbody>
                <tr>
                  ...
                  <td className="border p-2">Elite Ball Room</td>
                </tr>
                <tr>
                  <td className="border p-2 font-semibold">Pax</td>
                  <td className="border p-2">400-700</td>
                </tr>
                <tr>
